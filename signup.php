    ...
    <form method="post" action="signin.php">
        <div class="container">
            ...
            <div class="registration">
                ...
                <div class="mb-3 row">
                    <label for="inputConfirmPassword" class="col-md-3 col-form-label">Confirm Password:</label>
                    <div class="col-md-9">
                        <input type="password" class="form-control" id="inputConfirmPassword" name="confirm_password" value="">
                    </div>
                </div>
                <div class="mb-3 row">
